 ...
 * regardless of what is paid out in fees. See {@link com.fintex.ce.application.util.FeeProjectionUtils#growthFactor}
 * for the closed form and for what happens to a period that does not land on a year boundary.
 *
 * <p>
