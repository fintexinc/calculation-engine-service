...
/**
 * Abstraction for Alpha and Beta calculations. Since the Alpha totally uses the result of Beta and some functionality
 * (Excess Portfolio Return, Avg Excess Portfolio Return, Excess Benchmark Return, Avg Excess Benchmark Return) this
 * class is an abstract implementation of Beta calc but in the same time is reusable for Alpha.
 *
 * @param <T>
 *          response type.
 */
public abstract class AlphaBetaCalculationAbstract<T extends PeriodResult>
    extends
   ...
   *          average value of benchmarkExcessReturnByPeriod
   * @return beta value
   */
   ...
   */
  public BigDecimal calculateNumerator(final SortedMap<LocalDate, BigDecimal> portfolioExcessReturnByPeriod,
      final SortedMap<LocalDate, BigDecimal> benchmarkExcessReturnByPeriod,
      final BigDecimal portfolioExcessAverage,
      final BigDecimal benchmarkExcessAverage) {
   ...
   */
  public BigDecimal calculateDenominator(final SortedMap<LocalDate, BigDecimal> benchmarkExcessReturnByPeriod,
      final BigDecimal benchmarkExcessAverage) {
