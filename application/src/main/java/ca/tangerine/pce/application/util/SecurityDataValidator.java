 ...
 * {@link ErrorCode#NO_SECURITY_DATA_FOR_HOLDING} (HTTP 400) so the caller knows which holdings the data source couldn't
 * supply.
 */
@UtilityClass
public final class SecurityDataValidator {
  ...
  /**
   * Throws {@link ErrorCode#NO_SECURITY_DATA_FOR_HOLDING} for the first {@code requested} holding that
   * {@code mandatoryFor} accepts and whose {@link SecurityIdentifier} is not represented in {@code rawData}.
   *
   * <p>
