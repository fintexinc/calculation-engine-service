 ...
 * {@link ErrorCode#MISSING_NER_AND_GER} (MER-002) for the Fees metric as well as for MER — there is no Fees-only
 * Management-Fee fallback. The Management Fee <i>metric</i> is unaffected; it does not use this resolver (see
 * {@code ManagementFeeCalculationServiceImpl}).
 */
@Service
