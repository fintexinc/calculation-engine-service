...
abstract class AbstractGeographicExposureServiceTest<R extends GeographicExposureResult>
  ...
  void shouldReturnNullBuckets_whenOnlyCashAndGicHoldings() {
    CashHolding cashCad = cash("CASH-" + Currency.CAD, FiIdentifierType.MORNINGSTAR_ID, Currency.CAD, 1000);
    CashHolding cashUsd = cash("CASH-" + Currency.USD, FiIdentifierType.MORNINGSTAR_ID, Currency.USD, 500);
  ...
  void shouldComputeFullDistribution_whenHeterogeneousMultiCurrencyPortfolio() {
    ...
    CashHolding cash = cash("CASH-" + Currency.CAD, FiIdentifierType.MORNINGSTAR_ID, Currency.CAD, 1000);
    GicHolding gic = PortfolioHoldingBuildHelper.gic(
  ...
  void shouldExcludeCashAndGic_fromExposureAggregation() {
    ...
    CashHolding cashCad = cash("CASH-" + Currency.CAD, FiIdentifierType.MORNINGSTAR_ID, Currency.CAD, 500);
    CashHolding cashUsd = cash("CASH-" + Currency.USD, FiIdentifierType.MORNINGSTAR_ID, Currency.USD, 250);
    GicHolding gic = PortfolioHoldingBuildHelper.gic(
        new SecurityIdentifier("GIC-" + Currency.CAD, FiIdentifierType.MORNINGSTAR_ID), Currency.CAD,
