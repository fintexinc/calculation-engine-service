...
class FixedIncomeBondSectorCalculationServiceImplTest {
  ...
  private FixedIncomeBondSectorCalculationServiceImpl mockService(
    ...
    return mock(FixedIncomeBondSectorCalculationServiceImpl.class, withSettings()
  ...
  void shouldCalculate_whenVerifyAreAllValuesZerosInMapOfExposure() {
    try (var mockedPortfolioUtils = Mockito.mockStatic(PortfolioUtils.class)) {
      ...
      FixedIncomeBondSectorCalculationServiceImpl service = mockService(fixedIncomeFetcher, assetAllocationFetcher);
