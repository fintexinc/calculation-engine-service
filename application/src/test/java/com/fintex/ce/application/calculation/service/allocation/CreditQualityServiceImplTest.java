...
class CreditQualityServiceImplTest {
  ...
  private CreditQualityServiceImpl mockService(SecurityDataFetcher<CreditQuality> creditQualityFetcher,
      SecurityDataFetcher<HoldingAssetAllocation> assetAllocationFetcher,
      CreditQualityResponseMapper responseMapper) {
    return mock(CreditQualityServiceImpl.class, withSettings().useConstructor(
  ...
  void shouldPerform_whenVerifyLoad() {
    ...
    CreditQualityServiceImpl service = mockService(creditQualityFetcher, assetAllocationFetcher, responseMapper);
  ...
  void shouldGetFixedIncomeValue_returnsFixedIncomeOrZero() {
    CreditQualityServiceImpl service = mock(CreditQualityServiceImpl.class);
