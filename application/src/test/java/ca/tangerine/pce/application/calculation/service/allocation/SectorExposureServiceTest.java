...
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.CORPORATE_BONDS;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.ENERGY;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.GOVERNMENT_BONDS;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.OTHER;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.OTHER_BONDS;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.ST_INVESTMENTS;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.TECHNOLOGY;
import static ca.tangerine.wm.commons.domain.allocation.SectorAllocationType.UNKNOWN;
...
import ca.tangerine.pce.model.domain.calculation.allocation.SectorExposureData;
