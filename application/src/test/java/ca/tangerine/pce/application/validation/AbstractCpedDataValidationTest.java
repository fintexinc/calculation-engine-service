...
abstract class AbstractCpedDataValidationTest {
  ...
  protected abstract CpedDataValidation validator();
  ...
  @Test
  void shouldReturnEmptyErrors_whenCpedIsNull() {
  ...
  @Test
  void shouldReturnAfterPedError_whenCpedIsAfterPed() {
    ReturnsSnapshot<HoldingMonthlyReturns> snapshot = snapshot(LocalDate.parse("2020-01-31"),
        LocalDate.parse("2024-12-31"));

    ReturnsSnapshot<HoldingMonthlyReturns> result = validator().process(snapshot,
        ProcessingContext.of(null, LocalDate.parse("2025-12-31"), FxContext.empty()));
  ...
  @Test
  void shouldReturnBeforePsdError_whenCpedIsBeforePsd() {
    ReturnsSnapshot<HoldingMonthlyReturns> snapshot = snapshot(LocalDate.parse("2020-01-31"),
        LocalDate.parse("2024-12-31"));

    ReturnsSnapshot<HoldingMonthlyReturns> result = validator().process(snapshot,
        ProcessingContext.of(null, LocalDate.parse("2019-12-31"), FxContext.empty()));
  ...
  @Test
  void shouldReturnEmptyErrors_whenCpedIsWithinWindow() {
    ReturnsSnapshot<HoldingMonthlyReturns> snapshot = snapshot(LocalDate.parse("2020-01-31"),
        LocalDate.parse("2024-12-31"));

    ReturnsSnapshot<HoldingMonthlyReturns> result = validator().process(snapshot,
        ProcessingContext.of(null, LocalDate.parse("2022-06-30"), FxContext.empty()));
