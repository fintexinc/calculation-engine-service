...
public class FileUtils {
   ...
   */
  public static List<String> retrieveJsonFilenamesFromJarOrFolder(String folderPath) throws IOException,
      URISyntaxException {
  ...
  public static Object[][] getListOfFilenamesByPath(String folderPath) throws IOException, URISyntaxException {
    ...
    for (String jsonFilename : jsonFilenames) {
      final JSONObjectHolder jsonDTO = new ObjectMapper().readValue(FileUtils.class.getResourceAsStream("/" + folderPath
          + jsonFilename),
