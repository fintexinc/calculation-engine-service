...
public class YmlParser {
  ...
  /**
   * YML file parser. Return only one document
   *
   * @param relativePath
   *          relative path to YML file
   ...
   *          key name
   * @param map
   *          loaded map by YAML parser
   * @param newMap
   *          empty mutible map
   * @return new map
   * @newMapkey = full path to the poperty Escape of using nested maps
   */
  @SuppressWarnings("all")
