...
class BeanshellTest {
  ...
  String[] mutualFunds = {"RBF460", "RBF5658", "RBF546", "RBF658", "RBF101", "RBF252", "RBF4517", "RBF517", "RBF5517",
      "RBF461", "RBF5657", "RBF545", "RBF657", "RBF100", "RBF254", "RBF516", "RBF4516", "RBF5516", "PMO505", "PMO2505",
      "PMO2405", "PMO2205", "PMO2005", "PMO605", "PMO205", "PMO405", "PMO005", "RBF1005", "RBF270", "RBF114", "RBF137",
      "RBF601", "TDB2921", "TDB3081", "TDB030", "TDB107", "TDB969", "TDB3065", "TDB406", "TDB2002"};
  String[] canadaEtf = {"PMIF", "PMIF.U", "XIU", "ZSP", "ZSP.U", "ZAG", "XIC", "XSP", "XBB", "ZCPB", "RIFI", "XEF",
      "ZCN", "ZEA", "VAB", "VFV", "XSB", "CSAV", "VUN", "PSA", "ZLB", "XCB", "VCN", "XUS", "ZFL", "HXT", "ZIC.U", "ZIC",
      "NUBF", "HXS", "RIIN", "ZLU.U", "ZLU", "ZUE", "ZEM", "ISIF", "ZPR", "HBB", "ZWB", "ZMU", "IGAF", "VIU", "VSB",
      "ZST.L", "ZST", "VSC", "ZCS.L", "ZCS", "VGRO", "XAW", "XAW.U", "ZDB", "ZCM", "XUU", "XUU.U", "XDV", "XIN", "CBO",
      "VBAL", "VSP", "ZEB", "XRE", "VEE", "IFRF", "XGD", "HPR", "ZWP", "XFN", "NHYB", "CPD", "ZWH.U", "ZWH", "ZFS.L",
      "ZFS", "XGB", "CGL", "CGL.C", "XLB", "HXCN", "XSH", "VXC", "PSB"};
  String[] usEtf = {"MLPE", "VTI", "VOO", "VXUS", "BND", "SPY", "IVV", "BNDX", "VEA", "VO", "VUG", "QQQ", "VB", "VWO",
      "VTV", "AGG", "VXF", "VNQ", "IEFA", "BSV", "EFA", "GLD", "VIG", "IEMG", "IWF", "BIV", "IJH", "VEU", "VTIP", "IWM",
      "LQD", "VYM", "IJR", "USMV", "IWD", "VCSH", "VCIT", "VGT", "VBR", "SHV", "SHY", "XLK", "VV", "MBB", "VBK", "IEF",
      "ITOT", "TIP", "IAU", "IVW", "EEM", "TLT", "BIL", "DIA", "IWB", "XLV", "VOE", "GOVT", "VT", "SCHF", "SCHX", "VGK",
      "IWR", "MUB", "XLF", "QUAL", "IXUS", "SDY", "HYG", "VOT", "BLV", "XLP", "VMBS", "IGSB", "PFF", "SCHB", "IVE",
      "DVY", "MINT", "MDY", "IEI", "GDX", "EMB", "RSP", "VGSH", "XLY", "EFAV", "JPST", "XLU", "VHT", "SCHD", "VGIT",
      "SCHP", "IWP", "ACWI", "SPLV", "EWJ", "FLOT", "DGRO", "IGIB", "IWV"};

  JSONObject addObject(JSONObject root, String key, String value) throws JSONException {
    root.put(key, value);
    return root;
  }

  JSONObject addArray(JSONObject root, String key, String[] values) throws JSONException {
  ...
  JSONObject addDataProviders(JSONObject root, String[] dataProvider) throws JSONException {
    return addArray(root, "dataProviders", dataProvider);
  }

  JSONObject addParameterTypes(JSONObject root, String[] parameterType) throws JSONException {
    return addArray(root, "parameterTypes", parameterType);
  }

  JSONObject addCustomIntervalPerformanceStartDate(JSONObject root, String value) throws JSONException {
    return addObject(root, "customIntervalPerformanceStartDate", value);
  }

  JSONObject addCustomPerformanceStartDate(JSONObject root, String value) throws JSONException {
    return addObject(root, "customPerformanceStartDate", value);
  }

  JSONObject addCustomPerformanceEndDate(JSONObject root, String value) throws JSONException {
    return addObject(root, "customPerformanceEndDate", value);
  }

  JSONObject addCurrency(JSONObject root, String value) throws JSONException {
    return addObject(root, "currency", value);
  }

  JSONObject addTimeIntervalPeriods(JSONObject root, String[] timeIntervals) throws JSONException {
    return addArray(root, "timeIntervalPeriods", timeIntervals);
  }

  JSONObject addBestWorstTimeIntervalPeriods(JSONObject root, String[] timeIntervals) throws JSONException {
  ...
  JSONArray addETF(JSONArray holdings, String type, String ticker, int value) throws JSONException {
    JSONObject holding = new JSONObject();
  ...
  @Test
  void test_mer() throws JSONException {
  ...
  void test_total_trailing_returns() throws JSONException {
    ...
    addTimeIntervalPeriods(root, new String[] {"1", "3", "6", "12", "36", "60", "120", "43", "100", "YEAR_TO_DATE",
  ...
  void test_upsideCaptures() throws JSONException {
  ...
  void test_assetAllocation() throws JSONException {
  ...
  void test_equityCountryExposure() throws JSONException {
     ...
     * JSONArray benchmarkHoldings = new JSONArray();
     * 
     * addMutualFund(benchmarkHoldings, "FUNDSERV", mutualFunds[random(mutualFunds.length-1)], randomNZero(100)*100);
     * 
     * root.put("benchmarkHoldings", benchmarkHoldings);
     * 
     */
  ...
  void test_assetAllocationWithEmergingMarkets() throws JSONException {
  ...
  void test_fixedIncomeCreditQuality() throws JSONException {
  ...
  void test_fixedIncomeCountryExposure() throws JSONException {
  ...
  void test_equitySector() throws JSONException {
  ...
  void test_equityMarketCapitalization() throws JSONException {
  ...
  void test_annuralReturn() throws JSONException {
  ...
  void test_growthOf10K() throws JSONException {
  ...
  void test_bestWorstPeriod() throws JSONException {
  ...
  void test_leadingTotalReturns() throws JSONException {
  ...
  void test_standardDeviation() throws JSONException {
  ...
  void test_sharpeRatio() throws JSONException {
  ...
  void test_downsideDeviation() throws JSONException {
  ...
  void test_sortinoRatio() throws JSONException {
  ...
  void test_maxDrawDown() throws JSONException {
  ...
  void test_upsideCaptureRequirement() throws JSONException {
  ...
  void test_downsideCaptureRequirement() throws JSONException {
  ...
  void test_trackingError() throws JSONException {
  ...
  void test_excessReturn() throws JSONException {
  ...
  void test_Beta() throws JSONException {
  ...
  void test_Alpha() throws JSONException {
  ...
  void test_Correlation() throws JSONException {
  ...
  @Test
  void setup_part_1() throws JSONException {
    test_mer();
  ...
  @Test
  void setup_part_2() throws JSONException {
    test_mer();
    test_total_trailing_returns();
    test_upsideCaptures();
    test_assetAllocation();
