...
class TopHoldingsE2ETest extends AbstractPortfolioCalculationE2ETest {
  ...
  /**
   * Matches the Security Master REST fetcher response shape: a list of objects with { "identifier": {...}, "data":
   * {...} }.
   */
  private record SmsSecurityAttributeResult<T>(SecurityIdentifier identifier, T data) {
  }
}
