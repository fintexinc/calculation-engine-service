...
public class TabInfoDTO {
  ...
  // if TRUE then tab will be populated before each test case specifically for test case holdings / because of different
  // Data Providers
  // if FALSE then tab will be populated only at once at the beginning of testing for all holdings from HOLDINGS_DATA
  // tab
