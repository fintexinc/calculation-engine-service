...
public class PortfolioHoldingBuildHelper {
  ...
  public static PortfolioHolding etfCa(String ticker) {
    return etfCa(ticker, 1);
  }
  ...
  public static PortfolioHolding etfCaByMorningstarId(String id) {
    return holding(id, FiIdentifierType.MORNINGSTAR_ID, FinancialInstrumentType.ETF, Country.CANADA,
        (BigDecimal) null);
  }
  ...
  public static PortfolioHolding holding(String id, FinancialInstrumentType type, Country country) {
    return holding(id, null, type, country, (BigDecimal) null);
  }
  ...
  public static CashHolding cash(Currency currency, long value) {
    return cash(null, currency, BigDecimal.valueOf(value));
  }

  public static CashHolding cash(Currency currency, String value) {
    return cash(null, currency, new BigDecimal(value));
  }

  public static CashHolding cash(Currency currency, BigDecimal value) {
    return cash(null, currency, value);
  }

  public static CashHolding cash(String id, FiIdentifierType identifierType, Currency currency, long value) {
    return cash(new SecurityIdentifier(id, identifierType), currency, BigDecimal.valueOf(value));
  }

  public static CashHolding cash(SecurityIdentifier securityIdentifier, Currency currency, BigDecimal value) {
  ...
  public static GicHolding gic(BigDecimal clientIntRate, InterestFreq interestFreq, LocalDate investmentDate) {
    return gic(null, null, null, null, clientIntRate, interestFreq, investmentDate);
  }
