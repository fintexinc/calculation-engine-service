...
class DateTimeUtilsTest {
  ...
  private static Stream<Arguments> dataForRangeWithLastDayOfMonth() {
    return Stream.of(
        ...
        Arguments.of(LocalDate.of(2024, 8, 10), LocalDate.of(2024, 10, 10), List.of(LocalDate.of(2024, 8, 31), LocalDate
            .of(2024, 9, 30))),
        Arguments.of(LocalDate.of(2024, 8, 1), LocalDate.of(2024, 10, 31), List.of(LocalDate.of(2024, 8, 31), LocalDate
            .of(2024, 9, 30))),
        Arguments.of(LocalDate.of(2024, 8, 31), LocalDate.of(2024, 10, 1), List.of(LocalDate.of(2024, 8, 31), LocalDate
            .of(2024, 9, 30))));
  }
