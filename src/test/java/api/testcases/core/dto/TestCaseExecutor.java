...
/**
 * Used to trigger the test case execution right inside the test implementation.
 * In this way we are able to write all the logs just for specific test case and trigger any assertion during any step without interrupting the whole test suite
 *
 * @param <E>
 */
public class TestCaseExecutor<E> {
    ...
    /**
     * Should be executed only at once for the same test case!
     * During the first execution the result of this method should be stored into any variable or field and this method should not be called twice!
     *
