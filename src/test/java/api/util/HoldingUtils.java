...
import static com.fintex.ce.dto.holding.GicHolding.DEFAULT_START_DATE;
...
public class HoldingUtils {
    ...
    public static Holding createAppSpecificHoldingBasedOnType(final String holdingName, final BigDecimal holdingValue, HoldingDataDTO holdingDataDTO) {
    ...
    public static void setHoldingResponseDetails(Map.Entry<Holding, RIncomeForecast> entry, IncomeForecastDto incomeForecastDTO) {
    ...
    private static Currency mapCashNameToCurrency(String holdingName) {
        switch (holdingName) {
            case "CASH.U": return Currency.USD;
            case "CASH.C": return Currency.CAD;
            default: return null;
        }
    }
    ...
    private static Currency mapGicNameToCurrency(String holdingName) {
        switch (holdingName) {
            case "GIC.U": return Currency.USD;
            case "GIC.C": return Currency.CAD;
            default: return null;
        }
    }

    public static PortfolioHoldingDTO createAppSpecificHoldingV1x5(final String holdingName, final BigDecimal holdingValue, HoldingDataDTO holdingDataDTO) {
