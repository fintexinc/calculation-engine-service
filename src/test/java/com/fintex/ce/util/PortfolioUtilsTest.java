...
class PortfolioUtilsTest {
    ...
    void calculateInitialPortfolioWeight_test() {
        ...
        ComparisonUtils.compareMaps(Map.of(h1, new BigDecimal("0.500000000000000"), h2, new BigDecimal("0.500000000000000")), actual);
    }
    ...
    void areAllValuesInMapEmpty_checkResultWhenNotAllValuesInMapAreEmpty() {
        //SETUP
        final Map map = Map.of(new Holding(), Map.of(), new Holding(ONE, HoldingType.CANADA_MUTUAL_FUNDS), Map.of(AAA, ONE));
        //ACT
        final boolean actual = PortfolioUtils.areAllValuesInMapEmpty(map);
    ...
    void areAllValuesZerosInMap_checkResultWhenNotAllValuesInMapAreZeros() {
        //SETUP
        final Map map = Map.of(new Holding(), Map.of(EquityMarketCapType.GIANT, ZERO, EquityMarketCapType.SMALL, ZERO, EquityMarketCapType.LARGE, ONE));
        //ACT
        final boolean actual = PortfolioUtils.areAllValuesZerosInMap(map);
    ...
    void createKey_checkResultWhenHoldingTypeCanadaEtf() {
        //SETUP
        //ACT
        final String result = PortfolioUtils.createKey(new EtfHolding().setTicker("TICKER").setType(HoldingType.CANADA_ETF));
