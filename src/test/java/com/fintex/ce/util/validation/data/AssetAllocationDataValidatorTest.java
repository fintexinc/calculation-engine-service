...
import static com.fintex.ce.config.enumeration.ExceptionCode.WRN_AA_AA_001;
...
class AssetAllocationDataValidatorTest {
    ...
    void validateNonStock_verifyValidateForEachHolding() {
        ...
        final var holdings = new HashMap<Holding, RAssetAllocation>();
        ...
        //VERIFY
        holdings.forEach((holding, rAssetAllocation)
                -> verify(sut).validate(holding, rAssetAllocation.getAssetAllocation(), warnings));
    }
