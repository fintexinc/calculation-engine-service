...
class MaturityAllocationEtfCanadaEndpointTest {

    @Test
    void getGetCanadaEtfsByTickers_isPresent() {
        //SETUP
        final MaturityAllocationEtfCanadaEndpoint m = new MaturityAllocationEtfCanadaEndpoint();
    ...
    void requestMapper_verify() {
        //SETUP
        final MaturityAllocationEtfCanadaEndpoint m = mock(MaturityAllocationEtfCanadaEndpoint.class);
    ...
    void responseMapper_verify() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            //SETUP
            final MaturityAllocationEtfCanadaEndpoint sut = mock(MaturityAllocationEtfCanadaEndpoint.class);
