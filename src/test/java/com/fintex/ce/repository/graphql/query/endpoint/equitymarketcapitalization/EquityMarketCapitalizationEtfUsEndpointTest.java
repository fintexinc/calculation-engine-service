...
class EquityMarketCapitalizationEtfUsEndpointTest {

    @Test
    void getUsEtfsByTickers_isPresent() {
        //SETUP
        final EquityMarketCapitalizationEtfUsEndpoint m = new EquityMarketCapitalizationEtfUsEndpoint();
    ...
    void queryDefinition_verify() {
        //SETUP
        final EquityMarketCapitalizationEtfUsEndpoint m = mock(EquityMarketCapitalizationEtfUsEndpoint.class);
