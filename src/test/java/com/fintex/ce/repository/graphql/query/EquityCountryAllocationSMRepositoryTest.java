...
class EquityCountryAllocationFDSRepositoryTest {

    @Test
    void queryBenchOfFundCanada_verifyDoQuery() {
        //SETUP
        final var graphqlTransport = mock(GraphqlTransportComponent.class);
        final EquityCountryAllocationFDSRepository m = mock(EquityCountryAllocationFDSRepository.class,
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationFundCanadaEndpoint.class),
                eq(providers));
    }
    ...
    void queryBenchOfFundCanada_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfFundCanada(any(), anyList());
        //ACT
        final Map<FundSeriesHolding, REquityCountryAllocation> actual = m.queryBenchOfFundCanada(holdings, providers);
    ...
    void queryBenchOfOfEtfUs_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationEtfUsEndpoint.class),
                eq(providers));
    }
    ...
    void queryBenchOfOfEtfUs_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfOfEtfUs(any(), anyList());
        //ACT
        final Map<EtfHolding, REquityCountryAllocation> actual = m.queryBenchOfOfEtfUs(holdings, providers);
    ...
    void queryBenchOfEtfCanada_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationEtfCanadaEndpoint.class),
                eq(providers));
    }
    ...
    void queryBenchOfEtfCanada_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfEtfCanada(any(), anyList());
        //ACT
        final Map<EtfHolding, REquityCountryAllocation> actual = m.queryBenchOfEtfCanada(holdings, providers);
    ...
    void queryBenchOfBenchmarks_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationBenchmarkEndpoint.class),
                eq(providers));
    }
    ...
    void queryBenchOfBenchmarks_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfBenchmarks(any(), anyList());
        //ACT
        final Map<BenchmarkIndexHolding, REquityCountryAllocation> actual = m.queryBenchOfBenchmarks(holdings, providers);
    ...
    void queryUsMutualFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationUsMutualFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaHedgeFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationCanadaHedgedFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaHedgeFunds_checkResult() {
        ...
        doCallRealMethod().when(m).queryCanadaHedgeFunds(any(), anyList());
        //ACT
        final Map<CanadaHedgeFundHolding, REquityCountryAllocation> actual = m.queryCanadaHedgeFunds(holdings, providers);
    ...
    void queryCanadaPooledFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == EquityCountryAllocationCanadaPooledFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaPooledFunds_checkResult() {
        ...
        doCallRealMethod().when(m).queryCanadaPooledFunds(any(), anyList());
        //ACT
        final Map<CanadaPooledFundHolding, REquityCountryAllocation> actual = m.queryCanadaPooledFunds(holdings, providers);
