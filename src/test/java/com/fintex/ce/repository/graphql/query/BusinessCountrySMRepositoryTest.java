...
class BusinessCountrySMRepositoryTest {
    ...
    void queryBenchOfStock_verifyDoQuery() {
        ...
        final BusinessCountrySMRepository m = mock(BusinessCountrySMRepository.class, withSettings().useConstructor(graphqlTransport));
    ...
    void queryBenchOfStock_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfStock(any(), anyList());
        //ACT
        final Map<StockHolding, RBusinessCountry> actual = m.queryBenchOfStock(holdings, providers);
