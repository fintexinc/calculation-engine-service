...
class CommonHoldingsSMRepositoryTest {
    ...
    void queryUsMutualFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == CommonHoldingsUsMutualFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaHedgeFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == CommonHoldingsCanadaHedgeFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaHedgeFunds_checkResult() {
        ...
        doCallRealMethod().when(m).queryCanadaHedgeFunds(any(), anyList());
        //ACT
        final Map<CanadaHedgeFundHolding, RCommonHoldings> actual = m.queryCanadaHedgeFunds(holdings, providers);
    ...
    void queryCanadaPooledFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == CommonHoldingsCanadaPooledFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaPooledFunds_checkResult() {
        ...
        doCallRealMethod().when(m).queryCanadaPooledFunds(any(), anyList());
        //ACT
        final Map<CanadaPooledFundHolding, RCommonHoldings> actual = m.queryCanadaPooledFunds(holdings, providers);
