...
class FixedIncomeStyleboxExposureFundCanadaEndpointTest {

    @Test
    void getGetCanadaEtfsByTickers_isPresent() {
        //SETUP
        final FixedIncomeStyleboxExposureFundCanadaEndpoint m = new FixedIncomeStyleboxExposureFundCanadaEndpoint();
    ...
    void requestMapper_verify() {
        //SETUP
        final FixedIncomeStyleboxExposureFundCanadaEndpoint m = mock(FixedIncomeStyleboxExposureFundCanadaEndpoint.class);
    ...
    void responseMapper_verify() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            //SETUP
            final FixedIncomeStyleboxExposureFundCanadaEndpoint sut = mock(FixedIncomeStyleboxExposureFundCanadaEndpoint.class);
