...
class FixedIncomeBondSectorEtfUsEndpointTest {

    @Test
    void getUsEtfsByTickers_isPresent() {
        //SETUP
        final FixedIncomeBondSectorEtfUsEndpoint m = new FixedIncomeBondSectorEtfUsEndpoint();
    ...
    void queryDefinition_verify() {
        //SETUP
        final FixedIncomeBondSectorEtfUsEndpoint m = mock(FixedIncomeBondSectorEtfUsEndpoint.class);
