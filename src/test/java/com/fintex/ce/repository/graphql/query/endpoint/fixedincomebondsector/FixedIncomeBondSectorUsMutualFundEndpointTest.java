...
class FixedIncomeBondSectorUsMutualFundEndpointTest {
    ...
    void getUsEtfsByTickers_isPresent() {
        ...
        //ACT
        final Function<Query, List<UsFund>> actual = FixedIncomeBondSectorUsMutualFundEndpoint.getGetFDSEntityFunction();
    ...
    void requestMapper_verify() {
        //SETUP
        final FixedIncomeBondSectorUsMutualFundEndpoint FixedIncomeBondSectorUsMutualFundEndpoint = mock(FixedIncomeBondSectorUsMutualFundEndpoint.class);
    ...
    void responseMapper_checkResult() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            ...
            doCallRealMethod().when(sut).responseMapper(any(), any());
            //ACT
            final RFixedIncomeBondSecurities expected = sut.responseMapper(usFund, h);
