...
class ManagementFeeEtfUsEndpointTest {

    @Test
    void getGetCanadaEtfsByTickers_isPresent() {
        //SETUP
        final ManagementFeeEtfUsEndpoint m = new ManagementFeeEtfUsEndpoint();
    ...
    void requestMapper_verify() {
        //SETUP
        final ManagementFeeEtfUsEndpoint m = mock(ManagementFeeEtfUsEndpoint.class);
    ...
    void responseMapper_verify() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            //SETUP
            final ManagementFeeEtfUsEndpoint sut = mock(ManagementFeeEtfUsEndpoint.class);
