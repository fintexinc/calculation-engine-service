...
class EquityCountryAllocationEtfUsEndpointTest {

    @Test
    void getUsEtfsByTickers_isPresent() {
        //SETUP
        final EquityCountryAllocationEtfUsEndpoint m = new EquityCountryAllocationEtfUsEndpoint();
    ...
    void queryDefinition_verify() {
        //SETUP
        final EquityCountryAllocationEtfUsEndpoint m = mock(EquityCountryAllocationEtfUsEndpoint.class);
    ...
    void responseMapper_verifyEquityCountryAllocationMapper() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            //SETUP
            final var sut = mock(EquityCountryAllocationEtfUsEndpoint.class);
