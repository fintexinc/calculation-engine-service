...
class EquityStyleboxExposureEtfCanadaEndpointTest {

    @Test
    void getGetCanadaEtfsByTickers_isPresent() {
        //SETUP
        final EquityStyleboxExposureEtfCanadaEndpoint m = new EquityStyleboxExposureEtfCanadaEndpoint();
    ...
    void requestMapper_verify() {
        //SETUP
        final EquityStyleboxExposureEtfCanadaEndpoint m = mock(EquityStyleboxExposureEtfCanadaEndpoint.class);
    ...
    void responseMapper_verify() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            //SETUP
            final EquityStyleboxExposureEtfCanadaEndpoint sut = mock(EquityStyleboxExposureEtfCanadaEndpoint.class);
