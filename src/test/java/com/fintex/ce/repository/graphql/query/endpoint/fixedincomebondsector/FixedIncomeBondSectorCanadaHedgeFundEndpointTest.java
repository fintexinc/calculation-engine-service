...
class FixedIncomeBondSectorCanadaHedgeFundEndpointTest {
    ...
    void getUsEtfsByTickers_isPresent() {
        ...
        //ACT
        final Function<Query, List<HedgeFund>> actual = FixedIncomeBondSectorCanadaHedgeFundEndpoint.getGetFDSEntityFunction();
    ...
    void requestMapper_verify() {
        //SETUP
        final FixedIncomeBondSectorCanadaHedgeFundEndpoint FixedIncomeBondSectorCanadaHedgeFundEndpoint = mock(FixedIncomeBondSectorCanadaHedgeFundEndpoint.class);
    ...
    void responseMapper_checkResult() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            ...
            doCallRealMethod().when(sut).responseMapper(any(), any());
            //ACT
            final RFixedIncomeBondSecurities expected = sut.responseMapper(hedgeFund, h);
