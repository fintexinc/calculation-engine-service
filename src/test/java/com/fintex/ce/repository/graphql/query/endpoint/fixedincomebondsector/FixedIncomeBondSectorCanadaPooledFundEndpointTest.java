...
class FixedIncomeBondSectorCanadaPooledFundEndpointTest {
    ...
    void getUsEtfsByTickers_isPresent() {
        ...
        //ACT
        final Function<Query, List<PooledFund>> actual = FixedIncomeBondSectorCanadaPooledFundEndpoint.getGetFDSEntityFunction();
    ...
    void requestMapper_verify() {
        //SETUP
        final FixedIncomeBondSectorCanadaPooledFundEndpoint FixedIncomeBondSectorCanadaPooledFundEndpoint = mock(FixedIncomeBondSectorCanadaPooledFundEndpoint.class);
    ...
    void responseMapper_checkResult() {
        try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
            ...
            doCallRealMethod().when(sut).responseMapper(any(), any());
            //ACT
            final RFixedIncomeBondSecurities expected = sut.responseMapper(pooledFund, h);
