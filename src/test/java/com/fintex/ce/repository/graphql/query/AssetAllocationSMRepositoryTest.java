...
class AssetAllocationSMRepositoryTest {
    ...
    void queryBenchOfFundCanada_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfFundCanada(any(), anyList());
        //ACT
        final Map<FundSeriesHolding, RAssetAllocation> actual = m.queryBenchOfFundCanada(holdings, providers);
    ...
    void queryBenchOfOfEtfUs_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfOfEtfUs(any(), anyList());
        //ACT
        final Map<EtfHolding, RAssetAllocation> actual = m.queryBenchOfOfEtfUs(holdings, providers);
    ...
    void queryBenchOfEtfCanada_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfEtfCanada(any(), anyList());
        //ACT
        final Map<EtfHolding, RAssetAllocation> actual = m.queryBenchOfEtfCanada(holdings, providers);
    ...
    void queryBenchOfBenchmarks_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfBenchmarks(any(), anyList());
        //ACT
        final Map<BenchmarkIndexHolding, RAssetAllocation> actual = m.queryBenchOfBenchmarks(holdings, providers);
    ...
    void queryBenchOfFixedIncomes_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == AssetAllocationFixedIncomeEndpoint.class),
                eq(providers));
    }
    ...
    void queryBenchOfFixedIncomes_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfFixedIncomes(any(), anyList());
        //ACT
        final Map<FixedIncomeHolding, RAssetAllocation> actual = m.queryBenchOfFixedIncomes(holdings, providers);
    ...
    void queryBenchOfSeparatelyManagedAccount_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == AssetAllocationSeparatelyManagedAccountEndpoint.class),
                eq(providers));
    }
    ...
    void queryBenchOfSeparatelyManagedAccount_checkResult() {
        ...
        doCallRealMethod().when(m).queryBenchOfSeparatelyManagedAccounts(any(), anyList());
        //ACT
        final Map<SmaHolding, RAssetAllocation> actual = m.queryBenchOfSeparatelyManagedAccounts(holdings, providers);
    ...
    void queryCanadaHedgeFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == AssetAllocationCanadaHedgeFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaHedgeFunds_checkResult() {
        ...
        doCallRealMethod().when(m).queryCanadaHedgeFunds(any(), anyList());
        //ACT
        final Map<CanadaHedgeFundHolding, RAssetAllocation> actual = m.queryCanadaHedgeFunds(holdings, providers);
    ...
    void queryCanadaPooledFunds_verifyDoQuery() {
        ...
        //VERIFY
        verify(m).doQuery(eq(holdings), argThat(argument -> argument.getClass() == AssetAllocationCanadaPooledFundEndpoint.class),
                eq(providers));
    }
    ...
    void queryCanadaPooledFunds_checkResult() {
        ...
        doCallRealMethod().when(m).queryCanadaPooledFunds(any(), anyList());
        //ACT
        final Map<CanadaPooledFundHolding, RAssetAllocation> actual = m.queryCanadaPooledFunds(holdings, providers);
