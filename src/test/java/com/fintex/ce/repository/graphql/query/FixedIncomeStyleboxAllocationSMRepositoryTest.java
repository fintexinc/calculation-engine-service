...
class FixedIncomeStyleboxAllocationFDSRepositoryTest {

    @Test
    void queryBenchOfFundCanada_verifyDoQuery() {
        //SETUP
        final var graphqlTransport = mock(GraphqlTransportComponent.class);
        final FixedIncomeStyleboxAllocationFDSRepository m = mock(FixedIncomeStyleboxAllocationFDSRepository.class,
