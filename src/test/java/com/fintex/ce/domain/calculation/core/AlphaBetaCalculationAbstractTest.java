...
class AlphaBetaCalculationAbstractTest {
    ...
    void calculateNumerator_checkResult() {
        ...
        final var portfolioExcessReturnByPeriod = new TreeMap<>(Map.of(LocalDate.now(), BigDecimal.valueOf(1.01222986673534)));
        final var benchmarkExcessReturnByPeriod = new TreeMap<>(Map.of(LocalDate.now(), BigDecimal.valueOf(0.994895485347306)));
        ...
        //ACT
        final BigDecimal result = sut.calculateNumerator(portfolioExcessReturnByPeriod, benchmarkExcessReturnByPeriod, portfolioExcessAverage, benchmarkExcessAverage);
