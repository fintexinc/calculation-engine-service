...
class SortinoRatioCalculationTest {
    ...
    void calculatePeriodForNumberOfMonths_verifyGetDownsideDeviation() {
        ...
        when(sortinoRatioCalculation.calculateAverageArithmeticAnnualizedReturn(new TreeMap<>(), date, TWELVE)).thenReturn(BigDecimal.ONE);
    ...
    void defineResponseType_checkResult() {
        ...
        final var intervalResDto = new TimeIntervalResDTO("2015-01-01", ZERO);
        final var intervalResDto1 = new TimeIntervalResDTO("2018-02-02", ONE);
        ...
        //ACT
        final SortinoRatioResDTO sortinoRatioResDTO = sut.defineResponseType(pairs);
    ...
    void getDownsideDeviation_checkResult() {
        //SETUP
        final var downsideDeviationCalculation = mock(DownsideDeviationCalculation.class);
        final var calculationDTO = new CalculationDTO().setWeightedAveragePortfolioReturns(new TreeMap<>(Map.of(LocalDate.now(), TEN)));
        final var sut = mock(SortinoRatioCalculation.class, withSettings()
                .useConstructor(calculationDTO, Set.of(), new TreeMap<>(Map.of(LocalDate.now(), TEN)), downsideDeviationCalculation));
