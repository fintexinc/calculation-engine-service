...
class FixedIncomeBondSectorCalculationTest {
    ...
    void calculate_verifyAOM() {
        ...
        FixedIncomeSectorResDTO expected = getExpectedOfAom();

        //ACT
        final FixedIncomeSectorResDTO actual = sut.calculate();
    ...
    private FixedIncomeSectorResDTO getExpectedOfAom() {
        ...
        var expected = new FixedIncomeSectorResDTO(expectedResult, List.of());
        return expected;
    }
    ...
    void calculate_verifyAomAndRbf605() {
        ...
        Map<Holding, BigDecimal> fixedIncomePlusCash = Map.of(aom, BigDecimal.valueOf(0.6081876), rbf605, BigDecimal.valueOf(0.3489427));

        var sut = new FixedIncomeBondSectorCalculation(exposures, List.of(aom, rbf605), List.of(), fixedIncomePlusCash);

        FixedIncomeSectorResDTO expected = getExpectedOfAomAndRbf605();
    ...
    void calculate_verifyAamAndRbf605ButRbf605AAIsMissing() {
        ...
        Map<Holding, BigDecimal> fixedIncomePlusCash = Map.of(aom, BigDecimal.valueOf(0.6081876), rbf605, BigDecimal.valueOf(0.0));
    ...
    private FixedIncomeSectorResDTO getExpectedOfAomAndRbf605() {
        final HashMap<FixedIncomeSectorType, BigDecimal> expectedResult = new HashMap<>();
        ...
        return new FixedIncomeSectorResDTO(expectedResult, List.of());
    }
}
