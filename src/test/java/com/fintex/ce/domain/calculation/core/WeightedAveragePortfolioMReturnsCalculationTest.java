...
//
//        //ACT
//        final BigDecimal expected = cWeighted.holdingPortfolioBaseTotalReturnFormula(DateTimeUtils.toLastDayOfMonth(LOCAL_DATE_NOW), ZERO, fxRates);
//
//        //VERIFY
...
//        compareMaps(Map.of(h1, Map.of(dayBeforeStart, TEN, LOCAL_DATE_NOW, TEN), h2, Map.of(dayBeforeStart, ZERO, LOCAL_DATE_NOW, ZERO)), actual);
//    }
//
//}