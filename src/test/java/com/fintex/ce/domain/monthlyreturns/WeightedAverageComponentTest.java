...
class WeightedAverageComponentTest {
    ...
    void collectMonthlyWeightEntries_checkResult() {
        ...
        //ACT
        final Function<Map.Entry<Holding, TreeMap<LocalDate, BigDecimal>>, TreeMap<LocalDate, BigDecimal>>
                actualFunction = sut.collectMonthlyWeightEntries(map);

        final Map<LocalDate, BigDecimal> actual = actualFunction.apply(Map.entry(holding, new TreeMap<>(Map.of(date, oldValue))));
