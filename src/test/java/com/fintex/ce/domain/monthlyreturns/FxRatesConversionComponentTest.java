...
class FxRatesConversionComponentTest {
    ...
    void convert_fxRateIsNullThrowError() {
        ...
        //ACT
        final DataErrorException actual = assertThrows(DataErrorException.class, () -> sut.convert(returns, holdingCurrencies));
    ...
    private Map<LocalDate, FxRatesDTO> getFxRates() {
        ...
        fxRates.put(toLastDayOfMonth(LocalDate.now().plusMonths(1)), new FxRatesDTO(BigDecimal.valueOf(4), BigDecimal.valueOf(2)));
        fxRates.put(toLastDayOfMonth(LocalDate.now().plusMonths(2)), new FxRatesDTO(BigDecimal.valueOf(16), BigDecimal.valueOf(10)));
        return fxRates;
    }
