...
class EquityCountryExposureCalculationServiceImplTest {
    ...
    void calculateNetProduct_checkResult() {
        ...
        //ACT
        final BigDecimal actual = e.calculateNetProduct(canada, exposures, Map.of(h1, BigDecimal.valueOf(3), h2, BigDecimal.valueOf(4)));
    ...
    void calculateNetProduct_checkResult2() {
        ...
        doCallRealMethod().when(e).calculateNetProduct(any(), any(), any());
        //ACT
        final BigDecimal actual = e.calculateNetProduct(type, exposures, Map.of(h1, BigDecimal.valueOf(3), h2, BigDecimal.valueOf(4)));
    ...
    void calculate_checkResultWhenExposureIsAllZeroValuesMap() {
        try (var mockedPortfolioUtils = Mockito.mockStatic(PortfolioUtils.class)) {
            ...
            final var exposures = mock(Map.class);
            final var expected = new EquityCountryExposureResDTO(EquityCountryExposureCalculationServiceImpl.DEFAULT_MAP, List.of());
