...
class ManagementExpenseAbstractCacheStorageTest {
    ...
    void load_verifyCanadaMutualFund() {
        try (var mockedFilterUtils = Mockito.mockStatic(FilterUtils.class)) {
            ...
            final Map<HoldingType, Map<Holding, AverageManagementExpenseCalculationDTO>> load = sut.load(holdings, eagle, List.of(), new ParamHolderDTO());
    ...
    void load_verifyUsStockFund() {
        try (var mockedFilterUtils = Mockito.mockStatic(FilterUtils.class)) {
            ...
            mockedFilterUtils.when(() -> FilterUtils.filterHoldings(eq(holdings), eq(US_STOCKS_PREDICATE))).thenReturn(filtered);
    ...
    void load_verifyCanadaStockFund() {
        try (var mockedFilterUtils = Mockito.mockStatic(FilterUtils.class)) {
            ...
            mockedFilterUtils.when(() -> FilterUtils.filterHoldings(eq(holdings), eq(CANADA_STOCKS_PREDICATE))).thenReturn(filtered);
