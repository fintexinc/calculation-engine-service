...
class CacheStatisticServiceImplTest {
    ...
    void initDayOfWeekFunctionMap_checkResult() {
        ...
        //VERIFY
        map.get(SUNDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
        verify(repo).incrementSunday(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3");

        map.get(MONDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
        verify(repo).incrementMonday(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3");

        map.get(TUESDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
        verify(repo).incrementTuesday(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3");

        map.get(WEDNESDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
        verify(repo).incrementWednesday(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3");

        map.get(THURSDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
        verify(repo).incrementThursday(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3");

        map.get(FRIDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
        verify(repo).incrementFriday(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3");

        map.get(SATURDAY).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.STOCKS, "2", "3"));
    ...
    void mappedUnsavedHoldings_verifyExistsByCacheNameAndHoldingIdAndProvider() {
        ...
        //VERIFY
        verify(repo).existsByCacheNameEntityAndCacheCategoryAndHoldingIdAndProvider(CacheNameEntity.MER, CacheCategory.US_ETF, "ID", "PROVIDER");
    }
    ...
    void mappedUnsavedHoldings_verifyMapToStatisticEntity() {
        ...
        when(repo.existsByCacheNameEntityAndCacheCategoryAndHoldingIdAndProvider(any(), any(), any(), any())).thenReturn(false);
    ...
    void incrementForCurrentDay_checkResult() {
        ...
        verify(func).apply(new CacheStatisticServiceImpl.Parameters(CacheNameEntity.MER, CacheCategory.US_ETF, "ID", "PROVIDER"));
    }
