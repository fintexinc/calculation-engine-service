...
class MonthlyReturnsServiceTest {
    ...
    void getWeightedAverageWithCpsdAndCpedValidation_checkResult() {
        ...
        //ACT
        final NavigableMap<LocalDate, BigDecimal> actual = sut.getWeightedAverageWithCpsdAndCpedValidation(monthlyReturns, LOCAL_DATE_NOW, LOCAL_DATE_NOW.plusMonths(3));
    ...
    void getWeightedAverageWithCpedValidation_checkResult() {
        ...
        //ACT
        final NavigableMap<LocalDate, BigDecimal> actual = sut.getWeightedAverageWithCpedValidation(monthlyReturns, LOCAL_DATE_NOW);
    ...
    void getPortfolioMonthlyReturns_verifyInit() {
        ...
        then(monthlyReturns).should(inOrder).setFxRatesConversionComponent(eq(new FxRatesConversionComponent(fxRates, CAD)));
        then(monthlyReturns).should(inOrder).setMonthlyReturnsCutComponent(eq(new ReturnsCutComponent()));
        then(monthlyReturns).should(inOrder).setWeightedAverageComponent(eq(new WeightedAverageComponent(ReturnFactorScale.SCALE_OF_TWO)));
