...
class RSquaredCalculationServiceImplTest {
    ...
    void defineCalculationMethod_verifyBuildCalculationDto() {
        ...
        final var sut = mock(RSquaredCalculationServiceImpl.class, withSettings().useConstructor(null, tBillsCacheStorage, null, requestValidator));
    ...
    void defineCalculationMethod_verifyCalculateExcessReturn() {
        try (var mockedPeriodCalculationAbstract = Mockito.mockStatic(PeriodCalculationAbstract.class)) {
            //SETUP
            final var tBillsCacheStorage = mock(TBillsCacheStorage.class);
            final var sut = mock(RSquaredCalculationServiceImpl.class, withSettings().useConstructor(null, tBillsCacheStorage, null, null));
