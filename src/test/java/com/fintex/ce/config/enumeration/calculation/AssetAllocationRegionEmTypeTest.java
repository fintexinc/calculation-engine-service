...
class AssetAllocationRegionEmTypeTest {
    ...
    void of_verify() {
        ...
        //ACT
        AssetAllocationRegionEmType actual = AssetAllocationRegionEmType.of(AssetAllocationRegionEmType.CANADIAN_EQUITY.name());
    ...
    void of_verify2() {
        ...
        //ACT
        AssetAllocationRegionEmType actual = AssetAllocationRegionEmType.of(AssetAllocationRegionEmType.CANADIAN_EQUITY.getRegion());
