...
public class HoldingFactory {
    ...
    private Holding getEtf(final List<String> codes, final HoldingType holdingType, final LinkedList<Integer> randomIndexes) {
    ...
    private Holding getStock(final List<StockParseDTO> codes, final HoldingType holdingType, LinkedList<Integer> randomIndexes) {
        final int randomIndex = randomIndexes.pop();
