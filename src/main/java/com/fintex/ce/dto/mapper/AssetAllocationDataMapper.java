...
public class AssetAllocationDataMapper {
    ...
    static final Map<AssetAllocationRegion, BigDecimal> DEFAULT_MAP;
    ...
    public Map<Holding, Map<AssetAllocationRegion, BigDecimal>> mapForAA(final AssetAllocationDataDTO dto) {
    ...
    public Map<Holding, Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>>> mapForAAEM(final AssetAllocationDataDTO dto) {
        return map(dto);
    }
    ...
    private Map<Holding, Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>>> map(final AssetAllocationDataDTO dto) {
    ...
    private Map<Holding, Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>>> mapForStock(final Map<Holding, Map<AssetAllocationRegion, BigDecimal>> stockFdsResponse) {
    ...
    private Map<Holding, Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>>> mapForCash(final List<Holding> holdings) {
    ...
    private Map<Holding, Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>>> mapForGic(final List<Holding> holdings) {
        ...
        for (final var holding : holdings) {
            ...
            result.put(gic, Pair.of(null, overrideDefaultValues(DEFAULT_MAP, Map.of(gic.getAssetAllocation(), BigDecimal.ONE))));
        }
        return result;
    }

    private <H extends Holding> Map<Holding, Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>>> mapForNoneStock(final Map<H, RAssetAllocation> holdings) {
        return holdings.entrySet().stream().collect(
                toMap(
                        Map.Entry::getKey,
                        e -> mapToRegions(Pair.of(DataProvider.of(e.getValue().getProvider()), e.getValue().getAssetAllocation()))
                )
        );
    }

    private Pair<DataProvider, Map<AssetAllocationRegion, BigDecimal>> mapToRegions(final Pair<DataProvider, Map<String, BigDecimal>> pair) {
