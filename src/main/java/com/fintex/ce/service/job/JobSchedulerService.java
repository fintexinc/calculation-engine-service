...
public class JobSchedulerService {
    ...
    /**
     * At 03:00:00am EST every day
     * Keeps lock at least 1 minute and at most 1 hour.
     * ShedLock releases the lock directly after the task finishes if job takes more than 1 minute,
     * otherwise releases lock after 1 minute.
     */
    @Scheduled(cron = "0 0 3 * * *", zone = "EST")
