...
import com.fintex.ce.domain.calculation.RSquaredCalculation;
...
@Service
public class RSquaredCalculationServiceImpl extends PeriodBenchmarkAbstractService<RSquaredResDTO, PeriodsReqDTO> {
    ...
    @Override
    protected PeriodBasedCalculation<RSquaredResDTO> defineCalculationMethod(final PeriodsReqDTO reqDTO) {
