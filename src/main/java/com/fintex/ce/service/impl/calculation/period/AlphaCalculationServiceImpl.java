...
import com.fintex.ce.domain.calculation.AlphaCalculation;
...
@Service
public class AlphaCalculationServiceImpl extends PeriodBenchmarkAbstractService<AlphaResDTO, PeriodsReqDTO> {
    ...
    @Override
    protected PeriodBasedCalculation<AlphaResDTO> defineCalculationMethod(final PeriodsReqDTO reqDTO) {
