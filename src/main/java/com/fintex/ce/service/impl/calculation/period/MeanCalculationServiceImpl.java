...
@Service
public class MeanCalculationServiceImpl extends PeriodAbstractService<MeanResDTO, PeriodsReqDTO> {
    ...
    protected MeanCalculation defineCalculationMethod(final PeriodsReqDTO reqDTO) {
