...
public abstract class CalculationHeathIndicator<Req> implements HealthIndicator {
    ...
    protected List<Holding> getHoldings() {
        return List.of(new FundSeriesHolding(BigDecimal.ONE, "RBF605").setHoldingIdentifier(HoldingIdentifierType.FUNDSERV).setType(HoldingType.CANADA_MUTUAL_FUNDS));
    }
