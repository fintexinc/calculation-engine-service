package com.fintex.ce.repository.jdbc;
...
public interface FASUsageStatisticsRepo extends CrudRepository<SMUsageStatistics, Long> {
    ...
    int incrementSunday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
    ...
    int incrementMonday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
    ...
    int incrementTuesday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
    ...
    int incrementWednesday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
    ...
    int incrementThursday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
    ...
    int incrementFriday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
    ...
    int incrementSaturday(CacheNameEntity cacheNameEntity, CacheCategory cacheCategory, String holdingId, String dataProvider);
