...
public class EquityStyleboxExposureEtfUsEndpoint extends EquityStyleboxExposureEtfCanadaEndpoint {

    public EquityStyleboxExposureEtfUsEndpoint() {
        super(GET_US_ETFS_BY_TICKERS, List.of(), buildCacheName(EQUITY_STYLEBOX_ALLOCATION, US_ETF));
    }
