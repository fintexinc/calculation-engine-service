...
public class ClassificationAllocationEtfCanadaEndpoint extends EtfAbstractEndpoint<RClassificationAllocation> {
    ...
    @Override
    public RClassificationAllocation responseMapper(final Etf etf, final EtfHolding holding) {
