...
public class EquityMarketCapitalizationEtfUsEndpoint extends EquityMarketCapitalizationEtfCanadaEndpoint {

    public EquityMarketCapitalizationEtfUsEndpoint() {
        super(GET_US_ETFS_BY_TICKERS, List.of(), buildCacheName(EQUITY_MARKET_CAPITALIZATION, US_ETF));
    }
