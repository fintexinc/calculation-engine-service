...
public class ClassificationAllocationFixedIncomeEndpoint extends FixedIncomeAbstractEndpoint<RClassificationAllocation> {
    ...
    @Override
    public RClassificationAllocation responseMapper(final FixedIncome fixedIncome,
