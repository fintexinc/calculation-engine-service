...
public class FixedIncomeBondSectorEtfUsEndpoint extends FixedIncomeBondSectorEtfCanadaEndpoint {

    public FixedIncomeBondSectorEtfUsEndpoint() {
        super(GET_US_ETFS_BY_TICKERS, List.of(), buildCacheName(FIXED_INCOME_BOND_SECURITIES, US_ETF));
    }
