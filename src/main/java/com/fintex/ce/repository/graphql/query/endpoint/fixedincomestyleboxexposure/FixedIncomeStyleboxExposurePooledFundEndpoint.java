...
public class FixedIncomeStyleboxExposurePooledFundEndpoint extends CanadaPooledFundAbstractEndpoint<RFixedIncomeStyleboxExposure> {

    public FixedIncomeStyleboxExposurePooledFundEndpoint() {
        super(GET_CANADA_POOLED_FUNDS_BY_MORNINGSTAR_IDS, List.of(), buildCacheName(FIXED_INCOME_STYLEBOX_ALLOCATION, CacheCategory.CANADA_POOLED_FUNDS));
    }
    ...
    @Override
    public RFixedIncomeStyleboxExposure responseMapper(PooledFund pooledFund, CanadaPooledFundHolding holding) {
