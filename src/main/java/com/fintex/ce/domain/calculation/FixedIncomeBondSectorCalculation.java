...
public class FixedIncomeBondSectorCalculation {
    ...
    public FixedIncomeSectorResDTO calculate() {
        final Map<FixedIncomeSectorType, BigDecimal> netProducts = calculateFixedIncomeSectorAllocation(holdings, exposures, fixedIncomePlusCash);
        final Map<FixedIncomeSectorType, BigDecimal> reScaledValues = toUserScale(reScaleAbs(netProducts));
        return new FixedIncomeSectorResDTO(reScaledValues, warnings);
    }
    ...
    private BigDecimal calculateSumProduct(final Map<Holding, Map<FixedIncomeSectorType, BigDecimal>> fixedIncomeSectorType,
                                   final Map<Holding, BigDecimal> fixedIncomePlusCash,
