...
public class LeadingTotalReturnsCalculation extends PeriodCalculationAbstract<LeadingTotalReturnsResDTO, BigDecimal> {
    ...
    @Override
    public LeadingTotalReturnsResDTO defineResponseType(final Set<Pair<String, BigDecimal>> periodAndLeadingReturn) {
        final var result = new LeadingTotalReturnsResDTO();
        final var timeIntervals = formTimeIntervalResDTO(periodAndLeadingReturn);
