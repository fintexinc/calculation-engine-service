...
@Slf4j
public class TreynorRatioCalculation extends PeriodCalculationAbstract<TreynorRatioResDTO, BigDecimal> {
    ...
    public BigDecimal calculatePeriodForNumberOfMonths(int numberOfMonths) {
        ...
        final BigDecimal annualizedRiskFreeRate = calculateAverageArithmeticAnnualizedReturn(restrictTBillsRange(tBills), periodStartDate, numberOfMonths);
    ...
    @Override
    public TreynorRatioResDTO defineResponseType(final Set<Pair<String, BigDecimal>> result) {
        final var treynorRatioResDTO = new TreynorRatioResDTO();
    ...
    BigDecimal calculateTreynorRatio(final BigDecimal annualizedPortfolioReturn,
