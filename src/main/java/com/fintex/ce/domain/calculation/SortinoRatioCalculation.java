...
public class SortinoRatioCalculation extends PeriodCalculationAbstract<SortinoRatioResDTO, BigDecimal> {

    DownsideDeviationCalculation<SortinoRatioResDTO> downsideDeviationCalculation;
    ...
    public SortinoRatioCalculation(final CalculationDTO input,
                                   ...
                                   final DownsideDeviationCalculation<SortinoRatioResDTO> downsideDeviationCalculation) {
    ...
    public BigDecimal calculatePeriodForNumberOfMonths(final int numberOfMonths) {
        ...
        final BigDecimal annualizedPortfolioReturn = calculateAverageArithmeticAnnualizedReturn(getPortfolioTotalReturns(), periodStartDate, numberOfMonths);
        final BigDecimal annualizedRiskFreeRate = calculateAverageArithmeticAnnualizedReturn(tBills, periodStartDate, numberOfMonths);
    ...
    @Override
    public SortinoRatioResDTO defineResponseType(final Set<Pair<String, BigDecimal>> result) {
        final SortinoRatioResDTO sortinoRatioResDTO = new SortinoRatioResDTO();
     ...
     *
     * @param numberOfMonths number of month in the period.
     * @return final result of Downside Deviation by specified period.
     */
    BigDecimal getDownsideDeviation(final int numberOfMonths) {
     ...
     * @param downsideDeviation         calculated Downside Deviation value.
     * @return calculated Sortino Ratio result.
     */
    BigDecimal calculateSortinoRatio(final BigDecimal annualizedPortfolioReturn,
