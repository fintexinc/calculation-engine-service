...
public enum ParameterType {
    ...
    public static ParameterType fromJson(String name) {
        ...
        throw new ReqValidationException("Can not get Required ParameterType value.");
    }

    /*
     * @JsonValue was used to serialize ParameterType to its value
     * e.g 'FORCE_REPORT_FEE' would be serialized to 'forceReportFee'
     */
    @JsonValue
