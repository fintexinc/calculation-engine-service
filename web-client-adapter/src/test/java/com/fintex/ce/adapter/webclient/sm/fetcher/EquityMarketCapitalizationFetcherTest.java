...
class EquityMarketCapitalizationFetcherTest
    extends AbstractSecurityMasterFetcherTest<HoldingEquityMarketCap, EquityMarketCapitalization> {
  ...
  private EquityMarketCapitalizationFetcher fetcher;

  @BeforeEach
  void setUp() {
    fetcher = new EquityMarketCapitalizationFetcher(client, mapper, ENDPOINT_PATH);
  }
