...
class GeographicAllocationMapperTest {
  ...
  void shouldMapAllocationsCurrencyAndProvider_whenResponseHasValues() {
    ...
    HoldingGeographicAllocation result = mapper.map(smsResponse, createHolding("SEC-001"));
  ...
  void shouldKeepProvidersEmpty_whenDataProviderIsNull() {
    ...
    HoldingGeographicAllocation result = mapper.map(smsResponse, createHolding("SEC-003"));
  ...
  void shouldSumDuplicateAllocationKeys() {
    ...
    HoldingGeographicAllocation result = mapper.map(smsResponse, createHolding("SEC-004"));
  ...
  void shouldSkipNullValuesAndTypes() {
    ...
    HoldingGeographicAllocation result = mapper.map(smsResponse, createHolding("SEC-005"));
