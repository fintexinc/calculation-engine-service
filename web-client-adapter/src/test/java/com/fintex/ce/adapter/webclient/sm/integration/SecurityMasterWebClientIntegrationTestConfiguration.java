...
import com.fintex.ce.adapter.webclient.sm.fetcher.AllocationFetchers;
import com.fintex.ce.adapter.webclient.sm.fetcher.FinancialDataFetchers;
 ...
 * Maven cycle. This class wires only the Security Master WebClient, fetchers, and mappers — separate from the test
 * harness in {@link AbstractSecurityDataFetcherTest}.
 */
