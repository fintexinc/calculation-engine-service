...
class SmsTreasuryBillsFetcherImplTest {
  ...
  @SuppressWarnings("unchecked")
  @Test
  void shouldReturnEmptySeries_whenSecurityMasterReturnsEmptyList() {
    SecurityMasterWebClient client = mock(SecurityMasterWebClient.class);
    SmsTreasuryBillsFetcherImpl fetcher = new SmsTreasuryBillsFetcherImpl(client, ENDPOINT);
  ...
  @SuppressWarnings("unchecked")
  @Test
  void shouldRequestCurrencyAsPathSegment_whenInvokingSecurityMaster() {
    SecurityMasterWebClient client = mock(SecurityMasterWebClient.class);
    SmsTreasuryBillsFetcherImpl fetcher = new SmsTreasuryBillsFetcherImpl(client, ENDPOINT);
  ...
  @SuppressWarnings("unchecked")
  @Test
  void shouldBuildSortedSeries_whenSecurityMasterResponds() {
    SecurityMasterWebClient client = mock(SecurityMasterWebClient.class);
    SmsTreasuryBillsFetcherImpl fetcher = new SmsTreasuryBillsFetcherImpl(client, ENDPOINT);
