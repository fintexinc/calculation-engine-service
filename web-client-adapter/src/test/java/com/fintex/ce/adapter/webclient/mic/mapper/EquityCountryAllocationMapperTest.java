...
class EquityCountryAllocationMapperTest {
  ...
  void shouldMapAllocationsAndProvider_whenResponseHasCountryAllocationValues() {
    ...
    EquityCountryAllocation result = mapper.map(micResponse, holding("SEC-001", null, FinancialInstrumentType.ETF,
  ...
  void shouldReturnEmptyAllocations_whenResponseIsNull() {
    EquityCountryAllocation result = mapper.map(null, holding("SEC-002", null, FinancialInstrumentType.ETF,
        Country.CANADA, (BigDecimal) null));
  ...
  void shouldReturnEmptyAllocations_whenAllocationListIsNull() {
    ...
    EquityCountryAllocation result = mapper.map(micResponse, holding("SEC-003", null, FinancialInstrumentType.ETF,
        Country.CANADA, (BigDecimal) null));
  ...
  void shouldNotSetProvider_whenDataProviderIsNull() {
    ...
    EquityCountryAllocation result = mapper.map(micResponse, holding("SEC-004", null, FinancialInstrumentType.ETF,
        Country.CANADA, (BigDecimal) null));
