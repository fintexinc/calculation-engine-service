...
/**
 * Associates a {@link CompositeSecurityAttribute} with the SMS response type it deserializes into, the CE domain type
 * calculation services consume it as, and the {@link SecurityMasterResponseMapper} that performs the conversion. The
 * full set of bindings forms the attribute registry backing the generic security-attributes fetcher.
 *
 * @param <D>
 *          CE domain model type
 * @param <R>
 *          SMS API response type for the attribute
 */
