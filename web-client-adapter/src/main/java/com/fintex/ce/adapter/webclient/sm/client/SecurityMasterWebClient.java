...
/**
 * Generic WebClient for Security Master API calls.
 * Provides generic HTTP methods that can be used by specific fetchers.
 */
@Slf4j
@Component
...
public class SecurityMasterWebClient {
   ...
   * @param responseType parameterized type reference for response
