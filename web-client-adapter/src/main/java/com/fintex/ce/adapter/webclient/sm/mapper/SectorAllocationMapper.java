...
public class SectorAllocationMapper
    implements
      SecurityMasterResponseMapper<HoldingSectorAllocation, SectorAllocationWithCurrency> {

  @Override
  public HoldingSectorAllocation map(SectorAllocationWithCurrency smsResponse, PortfolioHolding holding) {
    Map<SectorAllocationType, BigDecimal> allocationMap = Optional.ofNullable(smsResponse)
  ...
  private Currency toCurrency(SectorAllocationWithCurrency smsResponse) {
