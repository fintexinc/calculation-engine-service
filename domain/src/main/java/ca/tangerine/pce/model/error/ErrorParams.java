 ...
 * and the holding-identifier extraction so {@link ErrorCode} and {@link BasePceException} agree on how parameters and
 * holding context flow into a {@link ca.tangerine.wm.commons.error.Notification}.
 */
@UtilityClass
public final class ErrorParams {
   ...
   * {@link BasePceException}. This metadata entry is the single source of truth for the holding identifier:
   * {@link ca.tangerine.wm.commons.error.Notification#getUuid()} always carries a freshly generated UUID, never the
   * holding id.
   */
