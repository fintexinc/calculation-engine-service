...
public enum ExceptionCode {
  ...
  public static final List<ExceptionCode> FX_RATE_EXCEPTION_CODES = List.of(ERR_RRC_MFR_001);
  ...
  public Warning warning(Holding h) {
    return new Warning(h.generateUserIdentifier(), this.message, this.name());
  }

  public Warning warning(Holding h, String param1, String param2) {
    return new Warning(h.generateUserIdentifier(), String.format(this.message, param1, param2), this.name());
  }

  public DataErrorException error(Holding h) {
    return new DataErrorException(this.message, h.generateUserIdentifier(), this);
  }
  ...
  public DataErrorException error(Holding h, String param1, String param2) {
    return new DataErrorException(String.format(this.message, param1, param2), h.generateUserIdentifier(), this);
  }

  public DataErrorException error(Holding h, Object param1) {
    return new DataErrorException(String.format(this.message, param1), h.generateUserIdentifier(), this);
  }
