...
public enum CalculationMetric {
  ...
  public static final List<CalculationMetric> TWELVE_MONTH_MINIMUM_METRICS = List.of(
      MEAN, SHARPE_RATIO, SORTINO_RATIO, DOWNSIDE_DEVIATION,
  ...
  /**
   * Categorizes the metric into a logical group for client consumption. Categories are: Returns, Risk, Allocations,
   * Fees, Income, and Analysis.
   */
  public String getCategory() {
    return switch (this) {
      case TRAILING_TOTAL_RETURNS, LEADING_TOTAL_RETURNS, ROLLING_TOTAL_RETURNS, EXCESS_RETURNS, ANNUAL_RETURNS,
          GROWTH_OF_10K -> "Returns";
      case STANDARD_DEVIATION, ROLLING_STANDARD_DEVIATION, MEAN, SHARPE_RATIO, ROLLING_SHARPE_RATIO, SORTINO_RATIO,
          MAX_DRAWDOWN, DOWNSIDE_DEVIATION, MAR_RATIO, TREYNOR_RATIO, INFORMATION_RATIO, TRACKING_ERROR, ALPHA, BETA,
          R_SQUARED, CORRELATION, ROLLING_CORRELATION, UPSIDE_CAPTURE, DOWNSIDE_CAPTURE -> "Risk";
      case ASSET_ALLOCATIONS, ASSET_ALLOCATIONS_EM, EQUITY_SECTOR, SECTOR_EXPOSURE, EQUITY_COUNTRY_EXPOSURE,
          EQUITY_STYLEBOX_EXPOSURE, EQUITY_GEOGRAPHIC_EXPOSURE, GEOGRAPHIC_EXPOSURE, EQUITY_MARKET_CAPITALIZATION,
          FIXED_INCOME_COUNTRY_EXPOSURE, FIXED_INCOME_GEOGRAPHIC_EXPOSURE, FIXED_INCOME_BOND_SECTOR,
          FIXED_INCOME_STYLEBOX_EXPOSURE, MATURITY_ALLOCATION, CLASSIFICATION_ALLOCATION -> "Allocations";
      case MER, MANAGEMENT_FEE, FEES, MER_BENCHMARK_COMPARISON, SALES_CHARGE -> "Fees";
      case INCOME_FORECAST, YIELD -> "Income";
      case BEST_WORST_PERIODS, DISTRIBUTION_OF_MONTHLY_RETURNS, COMMON_PERFORMANCE_DATES, TOP_COMMON_HOLDINGS,
          FIXED_INCOME_CREDIT_QUALITY, NUMBER_OF_UNIQUE_HOLDINGS -> "Analysis";
    };
  }
}
