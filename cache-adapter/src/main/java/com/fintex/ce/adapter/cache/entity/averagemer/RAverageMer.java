package com.fintex.ce.adapter.cache.entity.averagemer;
...
public class RAverageMer extends RedisId {
  ...
  // for now we have one DTO for both funds and etfs to simplify work with different types of holdings we have in the
  // system. So in one time we will have only half fields filled depends on etf or fund holding
