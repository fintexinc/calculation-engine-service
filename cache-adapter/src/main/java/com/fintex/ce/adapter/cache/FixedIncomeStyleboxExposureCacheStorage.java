...
public class FixedIncomeStyleboxExposureCacheStorage
  ...
  public FixedIncomeStyleboxExposureCacheStorage(
    ...
    super(securityDataPort, mapper, fixedIncomeStyleboxAllocationRepository, FIXED_INCOME_STYLEBOX_ALLOCATION);
  }
  ...
  public <H extends Holding> Map<Holding, Map<FixedIncomeStyleboxType, BigDecimal>> mapForNoneStock(
      final Map<H, FixedIncomeStyleboxExposure> holdings,
      final List<Warning> warnings) {
    return holdings.entrySet().stream().collect(toMap(Map.Entry::getKey, e -> fixedIncomeStyleboxExposureMapper(e,
        warnings)));
  }

  public <H extends Holding> Map<FixedIncomeStyleboxType, BigDecimal> fixedIncomeStyleboxExposureMapper(
      final Map.Entry<H, FixedIncomeStyleboxExposure> entry,
      final List<Warning> warnings) {
