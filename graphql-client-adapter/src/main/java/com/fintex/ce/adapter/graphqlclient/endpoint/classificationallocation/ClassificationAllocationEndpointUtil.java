...
public class ClassificationAllocationEndpointUtil {
  ...
  public static <T> ClassificationAllocation getResponseCacheEntity(final T type,
      final Supplier<SecurityClassificationAllocation> supplier1,
      final Supplier<SecurityClassification> supplier2) {
    final var cacheEntity = new ClassificationAllocation();
  ...
  private static Map<String, BigDecimal> getClassificationAllocation(
      final SecurityClassificationAllocation securityClassificationAllocation,
  ...
  private static Map<String, BigDecimal> getClassificationAllocation(
      final List<SecurityClassificationTypeValue> values) {
