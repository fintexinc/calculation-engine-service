...
public class MonthlyReturnsUsMutualFundEndpoint extends UsMutualFundAbstractEndpoint<MonthlyReturns> {
  ...
  @Override
  public MonthlyReturns responseMapper(final UsFund fundSeries, final UsMutualFundHolding holding) {
