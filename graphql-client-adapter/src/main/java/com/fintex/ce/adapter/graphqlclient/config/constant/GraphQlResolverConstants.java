package com.fintex.ce.adapter.graphqlclient.config.constant;
...
public class GraphQlResolverConstants {
  ...
  public static final ManagementFeeDatapointQueryDefinition MANAGEMENT_FEE_DATAPOINT_QUERY_DEFINITION = mf -> mf.value()
      .dataProvider();
  public static final FloatDatapointQueryDefinition FLOAT_WITH_DATA_PROVIDER_QUERY_DEFINITION = d -> d.value()
      .dataProvider();

  public static final StringDatapointQueryDefinition STRING_DATAPOINT_QUERY_DEFINITION = StringDatapointQuery::value;
  public static final StringDatapointQueryDefinition STRING_WITH_DATA_PROVIDER_DEFINITION = q -> q.value()
      .dataProvider();
