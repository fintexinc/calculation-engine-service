...
public abstract class StockAbstractEndpoint<Res>
    extends
      AbstractSMEndpoint<StockHolding, EquityIdentifiers, StockQuery, Stock, Res> {
  ...
  @Override
  public QueryQueryDefinition queryDefinition(final List<EquityIdentifiers> equityIdentifiers,
      UnaryOperator<StockQuery> preDefinedSMQuery) {
  ...
  @Override
  public StockHolding findHoldingBasedOnRes(final List<StockHolding> holdings, final Stock stock) {
   ...
   *
   * @param stock
   *          stock object from FDS
   * @return ids
   */
  public List<String> getIds(final Stock stock) {
  ...
  @Override
  public void populateEmptyResponseWithIdentifier(final List<Stock> responses, final StockHolding holding) {
  ...
  @Override
  public List<StockHolding> getNotExistingHoldings(final List<StockHolding> holdings, final List<Stock> responses) {
