...
import com.fintex.ce.adapter.graphqlclient.repository.CommonHoldingsGraphqlDataFetcher;
...
class CommonHoldingsGraphqlDataFetcherTest {

  @Test
  void queryBenchOfEtfCanada_verifyDoQuery() {
    // SETUP
    final var graphqlTransport = mock(GraphqlTransportComponent.class);
    final var smRepo = mock(CommonHoldingsGraphqlDataFetcher.class, withSettings().useConstructor(graphqlTransport));
  ...
  void queryBenchOfEtfCanada_checkResult() {
    // SETUP
    final var smRepo = mock(CommonHoldingsGraphqlDataFetcher.class);
    final var holdings = new ArrayList<EtfHolding>();
    final var providers = new ArrayList<DataProvider>();
  ...
  void queryUsMutualFunds_verifyDoQuery() {
    // SETUP
    final CommonHoldingsGraphqlDataFetcher m = mock(CommonHoldingsGraphqlDataFetcher.class);
