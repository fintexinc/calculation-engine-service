...
class CreditQualityFundCanadaEndpointTest {

  @Test
  void getUsEtfsByTickers_isPresent() {
    // SETUP
    final CreditQualityFundCanadaEndpoint m = new CreditQualityFundCanadaEndpoint();
  ...
  void requestMapper_verify() {
    // SETUP
    final CreditQualityFundCanadaEndpoint m = mock(CreditQualityFundCanadaEndpoint.class);
  ...
  void responseMapper_verifyEquityCountryAllocationMapper() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      // SETUP
      final CreditQualityFundCanadaEndpoint sut = mock(CreditQualityFundCanadaEndpoint.class);
