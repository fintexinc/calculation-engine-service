...
class FixedIncomeStyleboxExposureCanadaHedgeFundEndpointTest {
  ...
  void requestMapper_verify() {
    // SETUP
    final FixedIncomeStyleboxExposureCanadaHedgeFundEndpoint m = mock(
        FixedIncomeStyleboxExposureCanadaHedgeFundEndpoint.class);
  ...
  void responseMapper_verify() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      // SETUP
      final FixedIncomeStyleboxExposureCanadaHedgeFundEndpoint sut = mock(
          FixedIncomeStyleboxExposureCanadaHedgeFundEndpoint.class);
