...
class FixedIncomeBondSectorFundCanadaEndpointTest {
  ...
  void requestMapper_verify() {
    // SETUP
    final FixedIncomeBondSectorFundCanadaEndpoint fixedIncomeBondSectorFundCanadaEndpoint = mock(
        FixedIncomeBondSectorFundCanadaEndpoint.class);
  ...
  void responseMapper_checkResult() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      ...
      doCallRealMethod().when(sut).responseMapper(any(), any());
      // ACT
      final FixedIncomeBondSecurities expected = sut.responseMapper(fundSeries, h);
  ...
  void queryDefinition_verify() {
    ...
    // ACT
    final QueryQueryDefinition actual = fixedIncomeBondSectorFundCanadaEndpoint.queryDefinition(equityIdentifiers, mock(
        UnaryOperator.class));
    actual.define(qq);
