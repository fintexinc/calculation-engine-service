...
class EquityCountryAllocationGraphqlDataFetcherTest {

  @Test
  void queryBenchOfFundCanada_verifyDoQuery() {
    // SETUP
    final var graphqlTransport = mock(GraphqlTransportComponent.class);
    final EquityCountryAllocationGraphqlDataFetcher m = mock(EquityCountryAllocationGraphqlDataFetcher.class,
