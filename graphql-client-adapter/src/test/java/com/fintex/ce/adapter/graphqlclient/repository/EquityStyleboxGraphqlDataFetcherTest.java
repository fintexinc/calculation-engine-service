...
import com.fintex.ce.adapter.graphqlclient.repository.EquityStyleboxGraphqlDataFetcher;
...
class EquityStyleboxGraphqlDataFetcherTest {

  @Test
  void queryBenchOfFundCanada_verifyDoQuery() {
    // SETUP
    final var graphqlTransport = mock(GraphqlTransportComponent.class);
    final EquityStyleboxGraphqlDataFetcher m = mock(EquityStyleboxGraphqlDataFetcher.class,
