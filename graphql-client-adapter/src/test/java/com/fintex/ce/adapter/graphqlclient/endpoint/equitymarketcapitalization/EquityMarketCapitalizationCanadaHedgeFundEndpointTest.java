...
class EquityMarketCapitalizationCanadaHedgeFundEndpointTest {
  ...
  void requestMapper_verify() {
    // SETUP
    final EquityMarketCapitalizationCanadaHedgeFundEndpoint m = mock(
        EquityMarketCapitalizationCanadaHedgeFundEndpoint.class);
  ...
  void responseMapper_checkResult() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      // SETUP
      final EquityMarketCapitalizationCanadaHedgeFundEndpoint sut = mock(
          EquityMarketCapitalizationCanadaHedgeFundEndpoint.class);
      ...
      doCallRealMethod().when(sut).responseMapper(any(), any());
      // ACT
      final com.fintex.ce.domain.model.EquityMarketCapitalization expected = sut.responseMapper(hedgeFund, h);
