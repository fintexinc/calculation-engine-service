...
import com.fintex.ce.adapter.graphqlclient.repository.FixedIncomeStyleboxGraphqlDataFetcher;
...
class FixedIncomeStyleboxGraphqlDataFetcherTest {

  @Test
  void queryBenchOfFundCanada_verifyDoQuery() {
    // SETUP
    final var graphqlTransport = mock(GraphqlTransportComponent.class);
    final FixedIncomeStyleboxGraphqlDataFetcher m = mock(FixedIncomeStyleboxGraphqlDataFetcher.class,
    ...
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposureFundCanadaEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfFundCanada_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfFundCanada(any(), anyList());
    // ACT
    final Map<FundSeriesHolding, FixedIncomeStyleboxExposure> actual = m.queryBenchOfFundCanada(holdings, providers);
  ...
  void queryBenchOfOfEtfUs_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposureEtfUsEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfOfEtfUs_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfOfEtfUs(any(), anyList());
    // ACT
    final Map<EtfHolding, FixedIncomeStyleboxExposure> actual = m.queryBenchOfOfEtfUs(holdings, providers);
  ...
  void queryBenchOfEtfCanada_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposureEtfCanadaEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfEtfCanada_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfEtfCanada(any(), anyList());
    // ACT
    final Map<EtfHolding, FixedIncomeStyleboxExposure> actual = m.queryBenchOfEtfCanada(holdings, providers);
  ...
  void queryBenchOfBenchmarks_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposureBenchmarkEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfBenchmarks_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfBenchmarks(any(), anyList());
    // ACT
    final Map<BenchmarkIndexHolding, FixedIncomeStyleboxExposure> actual = m.queryBenchOfBenchmarks(holdings,
        providers);
  ...
  void queryUsMutualFunds_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposureCanadaUsMutualFundEndpoint.class),
        eq(providers));
  }
  ...
  void queryCanadaHedgeFunds_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposureCanadaHedgeFundEndpoint.class),
        eq(providers));
  }
  ...
  void queryCanadaHedgeFunds_checkResult() {
    ...
    doCallRealMethod().when(m).queryCanadaHedgeFunds(any(), anyList());
    // ACT
    final Map<CanadaHedgeFundHolding, FixedIncomeStyleboxExposure> actual = m.queryCanadaHedgeFunds(holdings,
        providers);
  ...
  void queryCanadaPooledFunds_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == FixedIncomeStyleboxExposurePooledFundEndpoint.class),
        eq(providers));
  }
  ...
  void queryCanadaPooledFunds_checkResult() {
    ...
    doCallRealMethod().when(m).queryCanadaPooledFunds(any(), anyList());
    // ACT
    final Map<CanadaPooledFundHolding, FixedIncomeStyleboxExposure> actual = m.queryCanadaPooledFunds(holdings,
        providers);
