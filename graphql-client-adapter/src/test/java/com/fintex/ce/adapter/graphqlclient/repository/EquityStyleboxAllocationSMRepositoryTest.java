...
import com.fintex.ce.adapter.graphqlclient.repository.EquityStyleboxAllocationSMRepository;
...
class EquityStyleboxAllocationSMRepositoryTest {
  ...
  void queryBenchOfFundCanada_verifyDoQuery() {
    ...
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposureFundCanadaEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfFundCanada_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfFundCanada(any(), anyList());
    // ACT
    final Map<FundSeriesHolding, EquityStyleboxExposure> actual = m.queryBenchOfFundCanada(holdings, providers);
  ...
  void queryBenchOfOfEtfUs_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposureEtfUsEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfOfEtfUs_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfOfEtfUs(any(), anyList());
    // ACT
    final Map<EtfHolding, EquityStyleboxExposure> actual = m.queryBenchOfOfEtfUs(holdings, providers);
  ...
  void queryBenchOfEtfCanada_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposureEtfCanadaEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfEtfCanada_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfEtfCanada(any(), anyList());
    // ACT
    final Map<EtfHolding, EquityStyleboxExposure> actual = m.queryBenchOfEtfCanada(holdings, providers);
  ...
  void queryBenchOfBenchmarks_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposureBenchmarkEndpoint.class),
        eq(providers));
  }
  ...
  void queryBenchOfBenchmarks_checkResult() {
    ...
    doCallRealMethod().when(m).queryBenchOfBenchmarks(any(), anyList());
    // ACT
    final Map<BenchmarkIndexHolding, EquityStyleboxExposure> actual = m.queryBenchOfBenchmarks(holdings, providers);
  ...
  void queryUsMutualFunds_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposureCanadaUsMutualFundEndpoint.class),
        eq(providers));
  }
  ...
  void queryCanadaHedgeFunds_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposureCanadaHedgeFundEndpoint.class),
        eq(providers));
  }
  ...
  void queryCanadaHedgeFunds_checkResult() {
    ...
    doCallRealMethod().when(m).queryCanadaHedgeFunds(any(), anyList());
    // ACT
    final Map<CanadaHedgeFundHolding, EquityStyleboxExposure> actual = m.queryCanadaHedgeFunds(holdings, providers);
  ...
  void queryCanadaPooledFunds_verifyDoQuery() {
    ...
    // VERIFY
    verify(m).doQuery(eq(holdings), argThat(argument -> argument
        .getClass() == EquityStyleboxExposurePooledFundEndpoint.class),
        eq(providers));
  }
  ...
  void queryCanadaPooledFunds_checkResult() {
    ...
    doCallRealMethod().when(m).queryCanadaPooledFunds(any(), anyList());
    // ACT
    final Map<CanadaPooledFundHolding, EquityStyleboxExposure> actual = m.queryCanadaPooledFunds(holdings, providers);
