...
class ManagementFeeGraphqlDataFetcherTest {

  @Test
  void queryBenchOfFundCanada_verifyDoQuery() {
    // SETUP
    final var graphqlTransport = mock(GraphqlTransportComponent.class);
    final var managementFeeFDSRepository = mock(ManagementFeeGraphqlDataFetcher.class,
  ...
  void queryUsMutualFunds_verifyDoQuery() {
    // SETUP
    final ManagementFeeGraphqlDataFetcher m = mock(ManagementFeeGraphqlDataFetcher.class);
