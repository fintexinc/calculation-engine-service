...
import com.fintex.ce.adapter.graphqlclient.repository.IncomeForecastGraphqlDataFetcher;
...
class IncomeForecastGraphqlDataFetcherTest {

  @Test
  void queryBenchOfFundCanada_verifyDoQuery() {
    // SETUP
    final var graphqlTransport = mock(GraphqlTransportComponent.class);
    final var incomeForecastFDSRepository = mock(IncomeForecastGraphqlDataFetcher.class,
  ...
  void queryBenchOfFixedIncomes_verifyDoQuery() {
    // SETUP
    final IncomeForecastGraphqlDataFetcher m = mock(IncomeForecastGraphqlDataFetcher.class);
