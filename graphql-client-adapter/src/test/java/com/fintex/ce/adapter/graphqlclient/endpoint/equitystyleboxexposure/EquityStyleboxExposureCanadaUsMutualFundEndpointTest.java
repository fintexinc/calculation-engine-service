...
class EquityStyleboxExposureCanadaUsMutualFundEndpointTest {
  ...
  void requestMapper_verify() {
    // SETUP
    final EquityStyleboxExposureCanadaUsMutualFundEndpoint m = mock(
        EquityStyleboxExposureCanadaUsMutualFundEndpoint.class);
  ...
  void responseMapper_verify() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      // SETUP
      final EquityStyleboxExposureCanadaUsMutualFundEndpoint sut = mock(
          EquityStyleboxExposureCanadaUsMutualFundEndpoint.class);
