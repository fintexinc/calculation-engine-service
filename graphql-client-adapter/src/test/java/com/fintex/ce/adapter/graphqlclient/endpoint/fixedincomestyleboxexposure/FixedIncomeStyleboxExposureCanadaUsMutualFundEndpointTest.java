...
class FixedIncomeStyleboxExposureCanadaUsMutualFundEndpointTest {
  ...
  void requestMapper_verify() {
    // SETUP
    final FixedIncomeStyleboxExposureCanadaUsMutualFundEndpoint m = mock(
        FixedIncomeStyleboxExposureCanadaUsMutualFundEndpoint.class);
  ...
  void responseMapper_verify() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      // SETUP
      final FixedIncomeStyleboxExposureCanadaUsMutualFundEndpoint sut = mock(
          FixedIncomeStyleboxExposureCanadaUsMutualFundEndpoint.class);
