...
class ClassificationAllocationEtfUsEndpointTest {

  @Test
  void getGetUsEtfsByTickers_isPresent() {
    // SETUP
    final ClassificationAllocationEtfUsEndpoint sut = new ClassificationAllocationEtfUsEndpoint();
  ...
  void queryDefinition_verify() {
    // SETUP
    final ClassificationAllocationEtfUsEndpoint sut = mock(ClassificationAllocationEtfUsEndpoint.class);
  ...
  void responseMapper_verifyWithSecurityClassificationAllocationData() {
    ...
    // ACT
    final ClassificationAllocation result = sut.responseMapper(etf, etfHolding);
