...
class EquityMarketCapitalizationCanadaPooledFundEndpointTest {
  ...
  void requestMapper_verify() {
    // SETUP
    final EquityMarketCapitalizationCanadaPooledFundEndpoint m = mock(
        EquityMarketCapitalizationCanadaPooledFundEndpoint.class);
  ...
  void responseMapper_checkResult() {
    try (var mockedGraphQlMapperUtils = Mockito.mockStatic(GraphQlMapperUtils.class)) {
      // SETUP
      final EquityMarketCapitalizationCanadaPooledFundEndpoint sut = mock(
          EquityMarketCapitalizationCanadaPooledFundEndpoint.class);
      ...
      doCallRealMethod().when(sut).responseMapper(any(), any());
      // ACT
      final com.fintex.ce.domain.model.EquityMarketCapitalization expected = sut.responseMapper(pooledFund, h);
