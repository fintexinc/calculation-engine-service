    ...
    for (Holding holding : this.holdings) {
      ...
      if (holding instanceof EtfHolding h) {
        ...
        if (!HoldingIdentifierType.TICKER.equals(h.getHoldingIdentifier())) {
          throw throwException(holding, "UsMutualFundHolding holding identifier could only be specified as: "
              + HoldingIdentifierType.TICKER);
        }
        ...
        if (!HoldingIdentifierType.MORNINGSTAR_ID.equals(h.getHoldingIdentifier())) {
          throw throwException(holding, "CanadaPooledFundHolding holding identifier could only be specified as: "
              + HoldingIdentifierType.MORNINGSTAR_ID);
        }
        ...
        if (!HoldingIdentifierType.MORNINGSTAR_ID.equals(h.getHoldingIdentifier())) {
          throw throwException(holding, "CanadaHedgeFundHolding holding identifier could only be specified as: "
              + HoldingIdentifierType.MORNINGSTAR_ID);
        }
        ...
        if (!HoldingIdentifierType.MORNINGSTAR_ID.equals(h.getHoldingIdentifier())) {
          throw throwException(holding, "Benchmark index holding identifier could only be specified as: "
              + HoldingIdentifierType.MORNINGSTAR_ID);
        }
        ...
        if (!HoldingIdentifierType.BROADRIDGE_ADP_NUMBER.equals(h.getHoldingIdentifier())) {
          throw throwException(holding, "Fixed Income Holding identifier could only be specified as: "
              + HoldingIdentifierType.BROADRIDGE_ADP_NUMBER);
        }
