...
@Component
public class TopCommonHoldingsReqValidator extends AbstractRequestValidator<TopCommonHoldingsCommand> {

  @Override
  public ReqValidation build(final TopCommonHoldingsCommand reqDTO) {
